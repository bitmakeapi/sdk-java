...
import com.freemex.open.api.domain.event.ChannelRequest;
import com.freemex.open.api.domain.event.EventTopic;
import com.freemex.open.api.domain.event.EventType;
...
public class WebSocketTest {
    public static void main(String[] args) {
        ...
        apiConfig.setQuoteWsBaseUrl("wss://ws.bytemars.co/t/v1/ws");
        apiConfig.setUserWsBaseUrl("wss://ws.bytemars.co/t/v1/ws");
